...
import com.zdlog.smartbutler.service.SmsService;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        boolean isSpeak=ShareUtils.getBoolen(this, "isSpeak", false);
        sw_speak.setChecked(isSpeak);
        boolean isSms=ShareUtils.getBoolen(this, "isSms", false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.sw_speak:
                ...
                //保存状态
                ShareUtils.putBoolen(this, "isSpeak", sw_speak.isChecked());
                break;
            case R.id.sw_sms:
                //切换相反
                sw_sms.setSelected(!sw_sms.isSelected());
                //保存状态
                ShareUtils.putBoolen(this, "isSms", sw_sms.isChecked());
                if (sw_sms.isChecked()){
    ...
    private void showUpdateDialog(String content) {
        new AlertDialog.Builder(this).setTitle("有新版本！")
                .setMessage(content)
                .setPositiveButton("更新", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //4、跳转到更新界面，并且把url传递过去
                        Intent intent = new Intent(SettingActivity.this, UpdataActivity.class);
